...
$fields = array('name' => 'Name', 'surname' => 'Surname', 'phone' => 'Phone', 'email' => 'Email', 'message' => 'Message', 'department' => 'Department', 'upload_file' => 'upload_file');
...
$smtpHost = 'sandbox.smtp.mailtrap.io'; // Enter SMTP host ie. smtp.gmail.com
$smtpUsername = 'c675680a938010'; // SMTP username ie. gmail address
$smtpPassword = 'bb86828b13cb8b'; // SMTP password ie gmail password
$smtpSecure = 'tls'; // Enable TLS or SSL encryption
$smtpAutoTLS = false; // Enable Auto TLS
$smtpPort = 2525; // TCP port to connect to
...
// $phpmailer->Port = 2525;
// $phpmailer->Username = 'c675680a938010';
// $phpmailer->Password = 'bb86828b13cb8b';
